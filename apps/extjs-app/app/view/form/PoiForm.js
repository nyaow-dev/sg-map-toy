...
Ext.define('SGMapApp.view.form.PoiForm', {
    ...
    requires: [
        'SGMapApp.view.form.PoiFormController'
    ],
    ...
    items: [{
        ...
        items: [
            ...
            },
            {
                ...
                allowBlank:     false,
                forceSelection: true,
                store:          ['hawker', 'park', 'mrt', 'school', 'mall', 'community', 'health', 'sport', 'landmark'],
                queryMode:      'local'
            },
            {
                xtype:      'textareafield',
            ...
            },
            {
                ...
                xtype:  'displayfield',
                value:  '<span style="color:#888;font-size:11px">💡 Tip: close this window and click the map to pre-fill coordinates</span>'
            }
        ]
    }],
